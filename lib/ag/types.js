(function() {
  var Failure, Success, assertFunction, isArray, isObject, listSequence, map, mapValues, nativeTypeValidator, objectSequence, objectWithProperty, pairs, pairsToObject, types, _ref, _ref1;
  ...
  module.exports = types = {
    ...
    OneOf: function(types) {
      var fail, type, validation, _i, _j, _len, _len1;
